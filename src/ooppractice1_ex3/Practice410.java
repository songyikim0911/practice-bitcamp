...
public class Practice410 {
  ...
  static class Score{
     ...
     * 리턴타입을 선언하지 않는다. 즉 값을 리턴하지 않는다.
     * 인스턴스를 만들 때 자동 호출된다.
     * 일반 메서드처럼 나중에 따로 호출할 수 없다.
     * 만약 개발자가 생성자를 만들지 않으면 컴파일러가 기본생성자를 자동으로 생성해준다.
  ...
  public static void main(String[] args) {
    ...
    Score s1 = new Score();//드디어 클래스명 다음에 오는 괄호() 의 의미를 알게 된 것!
    //생성자를 호출하지 않을 수 있는가?
    //컴파일 오류!! ex) Score s2 = new score;
